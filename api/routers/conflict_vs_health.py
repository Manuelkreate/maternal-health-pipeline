...
# define Table ID
TABLE_ID = 'maternal-health-pipeline.maternal_health_dbt.mart_conflict_vs_health'

@router.get('/states/conflict-vs-health')
async def get_conflict_vs_health(
    # optional parameters
    ...
    """
    Queries BigQuery for conflict vs health data, optionally filtering by state names, survey year and zone
    """
    try:
        # validation
