...
# define Table ID
TABLE_ID = 'maternal-health-pipeline.maternal_health_dbt.mart_state_rankings'

@router.get('/states/state-rankings')
async def get_state_rankings(
    ...
    """
    Queries BigQuery for state rankings by improvement data, optionally filtering by state names, survey year and zone
    """
    try:
        # validation
